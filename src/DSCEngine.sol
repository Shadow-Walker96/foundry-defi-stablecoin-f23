 ...
 *
 * The system is designed to be as minimal as possible, and have the tokens maintain a 1 token == $1 peg at 
 * all times.
 * 
 ...
 * 
 * Our DSC system should always be "overcollateralized". At no point, should, should the value
 * of all collateral <== The $ backed value of all DSC.
 *
 * @notice This contract is the core of the Decentralized Stablecoin system. It handles all the logic
 * for minting and redeeming DSC, as well as depositing and withdrawing collateral.
 * @notice This contract is based on the MakerDAO DSS system
 * 
 * @notice We make all of our code modular in our project so that we can reuse it. i.e _burnDsc() and the likes
 * is a function and other function calls it. This makes our code more readable and easier to maintain.
 * 
 * We follow a concept called 
 * 
 * DRY: Dont Repeat Yourself
 * 
 * @notice We follow CEI: Check, Effect and Interact in our code.
 */
...
contract DSCEngine is ReentrancyGuard {
    ...
    ///////////////////
    /*
     * @notice We follow CEI: Check, Effect and Interact
     * @param amountDscToMint: The amount of DSC you want to mint
     ...
     * the health factors been broken
     */
    function _burnDsc(uint256 amountDscToBurn, address onBehalfOf, address dscFrom) private {
        ...
        /**
         * @dev This conditional below is hypothetically unreachable, because if the transfer failed we
         * would have to throw the transfer From Failed Error
         */
        if (!success) {
            revert DSCEngine__TransferFailed();
        }
